 ...
 */
package com.gap.pino_copy.widget.persiandatepicker.util;
...
public class PersianCalendar extends GregorianCalendar {
	...
	public String getPersianShortDate_year() {
		// calculatePersianDate();
		return "" + formatToMilitary(this.persianYear);
	}

	public String getPersianShortDate_month() {
		// calculatePersianDate();
		return "" + formatToMilitary(getPersianMonth());
	}

	public String getPersianShortDate_day() {
		// calculatePersianDate();
		return "" + formatToMilitary(this.persianDay);
	}
