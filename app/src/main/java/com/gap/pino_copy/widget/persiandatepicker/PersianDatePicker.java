package com.gap.pino_copy.widget.persiandatepicker;
...
import com.gap.pino_copy.widget.persiandatepicker.util.PersianCalendar;
import com.gap.pino_copy.widget.persiandatepicker.util.PersianCalendarConstants;
import com.gap.pino_copy.widget.persiandatepicker.util.PersianCalendarUtils;
...
public class PersianDatePicker extends LinearLayout {
    ...
    public static NumberPicker yearNumberPicker;
    public static NumberPicker monthNumberPicker;
    public static NumberPicker dayNumberPicker;
    ...
    private void numberPickerStyle(NumberPicker numberPicker, Context context) {
        // Set divider color
        Typeface face = Typeface.createFromAsset(context.getAssets(), "BKoodakBold.ttf");
        numberPicker.setDividerColor(ContextCompat.getColor(context, R.color.dark_grey));
        numberPicker.setDividerColorResource(R.color.dark_grey);
        numberPicker.setSelectedTypeface(face);
        ...
        numberPicker.setSelectedTextColor(ContextCompat.getColor(context, R.color.dark_grey));
        numberPicker.setSelectedTextColorResource(R.color.dark_grey);
    ...
    public static void showDatePickerCopy(Context context, LayoutInflater inflater, final TextView editText, String select) {
        ...
        builder.setPositiveButton(" انتخاب ", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (select.equals("year")) {
                    String selectedDate = dpStartDate.getDisplayPersianDate().getPersianShortDate_year();
                    editText.setText(CommonUtil.farsiNumberReplacement(selectedDate));
                } else if (select.equals("month")) {
                    String selectedDate = dpStartDate.getDisplayPersianDate().getPersianShortDate_month();
                    editText.setText(CommonUtil.farsiNumberReplacement(selectedDate));
                } else {
                    String selectedDate = dpStartDate.getDisplayPersianDate().getPersianShortDate_day();
                    editText.setText(CommonUtil.farsiNumberReplacement(selectedDate));
                }
